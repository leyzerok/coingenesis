...
const Attestation: React.FC = () => {
  ...
  CoinGenesis combines several key components to create an all-in-one solution for launching and trading tokens.
        ...
        <h1 className="text-2xl font-bold mb-4">Token Deploy Proposal</h1>
        ...
        <h1 className="text-3xl font-bold mb-4">Pre-Market Trading</h1>
        <ul className="list-disc text-left text-lg mb-8 ml-6 space-y-4">
          <li>
        ...
        <h1 className="text-4xl font-bold mb-4">Mission and Vision</h1>
        <ul className="list-disc text-left text-lg mb-8 ml-6 space-y-4">
        <li>
