  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#dcdee4] p-4">
      <div className="my-16 max-w-6xl">
        ...
        <div className="pl-4">
          <h1 className="text-3xl font-bold mb-4 ml-8 pl-1">
          ...
          <h1 className="text-3xl font-bold mb-4 ml-8 my-6 pl-1">Key features</h1>
          <h1 className="text-2xl font-bold mb-4 ml-8 pl-1">Token Deploy Proposal</h1>
          ...
          <h1 className="text-3xl font-bold mb-4 ml-8 pl-1">Certified Deployer Attestation</h1>
          <ul className="list-disc text-left text-lg mb-8 ml-8 space-y-4">
            <p>
          ...
          <h1 className="text-3xl font-bold mb-4 ml-8 pl-1">Pre-Market Trading</h1>
          <ul className="list-disc text-left text-lg mb-8 ml-8 space-y-4">
            <p>
          ...
          <h1 className="text-4xl font-bold mb-4 ml-8 pl-1">Mission and Vision</h1>
          <ul className="list-disc text-left text-lg mb-8 ml-8 space-y-4">
            <p>
